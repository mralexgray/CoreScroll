...
- (id) init {
	...
	[self addConstraint:[CAConstraint constraintWithAttribute:kCAConstraintWidth relativeTo:@"superlayer" attribute:kCAConstraintWidth offset:0]];
...
- (void) createScrollTray {
	...
	tray.backgroundColor = cgGREEN;//SPACERCOLOR;
